      ...
      <div className="mb-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 px-1">
        <div>
          ...
          <p className="text-muted-foreground mt-2 font-medium">
            Daily check-in logs and duration reports
          </p>
        </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-b border-border/80 bg-muted/40 hover:bg-transparent">
                  ...
                  <TableHead className="min-w-[140px] px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    Check In Location
                  </TableHead>
                  <TableHead className="min-w-[140px] px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    Check Out Location
                  </TableHead>
                  <TableHead className="w-0 whitespace-nowrap px-3 py-2.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                    Duration
                  </TableHead>
                  ...
                  >
                    ...
                    <TableCell className="px-3 py-3">
                      <div className="font-medium text-foreground">
                        {[record.check_in_city, record.check_in_state].filter(
                          Boolean,
                        ).length
                    ...
                    <TableCell className="px-3 py-3">
                      <div className="font-medium text-foreground">
                        {record.check_out_time ? (
                          [
                            record.check_out_city,
                            record.check_out_state,
                    ...
                    <TableCell className="px-3 py-3">
                      <Badge
                        variant="secondary"
                        className="rounded-md border-0 bg-primary/10 font-mono text-xs font-medium text-primary"
                      >
                      ...
                      <div className="flex flex-col items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-0.5 text-sm text-muted-foreground">
                            Select another range or wait for check-ins
                          </p>
                        </div>
                      </div>
                    </TableCell>
